...
/*   Updated: 2026/08/15 12:01:57 by pswirgie         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	Bureaucrat::executeForm(AForm const & form) const
{
	...
	{
		std::cout << RED << _name << " not executed " << form.getName();
...
Bureaucrat::GradeTooHighException::GradeTooHighException()
	:range_error(RED "Bureaucrat grade is too high." RESET)
{}

Bureaucrat::GradeTooLowException::GradeTooLowException()
	:range_error(RED "Bureaucrat grade is too low." RESET)
{}